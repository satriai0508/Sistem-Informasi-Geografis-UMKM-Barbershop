      ...
      <div class="card-body">
        ...
        <div class="form-group row mb-2">
          ...
          <div class="col-md-6">
            <input type="text" class="form-control form-control-plaintext @error('nama_toko')
                                is-invalid
                            @enderror" id="nama_toko" name="nama_toko" placeholder="Enter Nama Toko" required value="{{ old('nama_toko',$layanans->nama_toko) }}" autofocus />
            @error('nama_toko')
        ...
        <div class="form-group row mb-2">
          <label for="nama" class="col-sm-3 text-end control-label col-form-label">Jenis Pemotongan
            Rambut</label>
          <div class="col-md-6">
            <input type="text" class="form-control form-control-plaintext @error('nama') is-invalid @enderror" id="nama" name="nama" placeholder="Enter Models" required value="{{ old('nama', $layanans->nama) }}" autofocus />
            @error('nama')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="form-group row mb-2">
          ...
          <div class="col-md-6">
            <input type="text" class="form-control form-control-plaintext @error('harga') is-invalid @enderror" id="harga" name="harga" placeholder="Enter Prices (RP)" required value="{{ old('harga', $layanans->harga) }}" />
            @error('harga')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
