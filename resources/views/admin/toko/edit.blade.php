...
@section('container')
    <div class="card">
        <div class="card-body">
            <form class="form-group" method="post" action="/admin/toko/{{ $tokos->id }}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="card-body mb-2">
                ...
                @cannot('admin')
                 <div class="form-group row mb-2">
                    ...
                    <input type="text" class="form-control form-control-plaintext @error('nama')
                                is-invalid
                            @enderror" id="nama" name="nama" placeholder="Enter Nama Toko" required value="{{ old('nama', auth()->user()->name) }}" readonly />
                    @error('nama')
                ...
                <div class="col-md-6">
                    <textarea type="text" class="form-control form-control-plaintext @error('alamat')
                                            is-invalid
                                        @enderror" id="alamat" name="alamat" placeholder="Enter Address" required value="{{ old('alamat',$tokos->alamat) }}" ></textarea>
                    @error('alamat')
                    <div class="invalid-feedback">
                    {{ $message }}
                    </div>
                ...
                <div class="form-group row mb-2">
                    ...
                    <input type="text" class="form-control form-control-plaintext @error('hari_buka')
                                is-invalid
                            @enderror" id="hari_buka" name="hari_buka" placeholder="Enter Open Day" required value="{{ old('hari_buka',$tokos->hari_buka) }}"/>
                    @error('hari_buka')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group row mb-2">
                    ...
                    <input type="text" class="form-control form-control-plaintext @error('hari_tutup')
                                is-invalid
                            @enderror" id="hari_tutup" name="hari_tutup" placeholder="Enter Close Day" required value="{{ old('hari_tutup',$tokos->hari_tutup) }}"/>
                    @error('hari_tutup')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
